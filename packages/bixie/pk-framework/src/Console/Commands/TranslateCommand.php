...
/**
 * Create .pot file:
 *  `php ./pagekit extension:translate bixie/pk-framework`
 * Create .php files
 *  `php ./pagekit framework:translate [en_US]`
 */
namespace Bixie\PkFramework\Console\Commands;
...
class TranslateCommand extends Command
{
     ...
     * {@inheritdoc}
     */
    protected $name = 'framework:translate';
