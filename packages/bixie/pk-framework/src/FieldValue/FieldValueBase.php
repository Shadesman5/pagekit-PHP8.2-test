...
abstract class FieldValueBase implements FieldValueInterface {
	...
	/**
	 * @var \Bixie\PkFramework\FieldType\FieldTypeBase
	 */
	protected $fieldType;
	...
	public function setField (FieldBase $field) {
		$this->field = $field;
		$this->fieldType = App::module('bixie/pk-framework')->getFieldType($field->type);
		return $this;
	}
	...
	public function getFieldType () {
		if (!isset($this->fieldType)) {
			$this->fieldType = App::module('bixie/pk-framework')->getFieldType($this->field->type);
		}
